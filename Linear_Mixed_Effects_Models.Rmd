...
_**Fitting linear mixed effect models on M-values using the R lme4 package, with participant id included as a random effect and exposure, sex, and age considered as fixed effects**_
