...
#Mutation load distributions - Extract from dash python visualization platform
...
try:
	...
	p=pd.read_pickle('/home/rasiimwe/dash/df.pkl')
	#print(p)
	#x=df.dtypes
	#print (x)
	#print(df)
...
#	signatures = pd.read_csv('/Users/rasiimwe/signatures.csv')
	...
	image_filename = '/home/rasiimwe/dash/cicros.pdf' 
