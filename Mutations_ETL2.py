...
try:
    con = psycopg2.connect(
        "host='localhost' dbname='dbname' user='rasiimwe' password='password'")
    ...
    flout2 = open(
        "/home/rasiimwe/Projects/destruct_breakpoint_read.txt", "a")
    flout3 = open(
        "/home/rasiimwe/Projects/destruct_breakpoint_table.txt", "a")
...
#Sytem file change, new call below
# ----------------------------------------------------------------------------------------
    flout3.close()
    os.chdir("/home/rasiimwe/Projects/")
    flout3 = open(
        "/home/rasiimwe/Projects/destruct_breakpoint_table.txt", "r")
